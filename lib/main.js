...
panel.port.on("pleasePrefs", function() {
  console.info("received pleasePrefs");

// Open the add-on's preference panel (the url has to be replaced by your own add-on view url):
Services.wm.getMostRecentWindow('navigator:browser').BrowserOpenAddonsMgr('addons://detail/jid1-48sPyP04VraOpA%40jetpack/preferences');
